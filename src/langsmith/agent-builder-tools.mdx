...
To disconnect a connected app (for example, Slack, Gmail, or GitHub):

<Steps>
  <Step title="Open Agent settings">
    In the [LangSmith UI](https://smith.langchain.com), hover over <b>My Agents</b> in the left sidebar and click the <Icon icon="gear" /> settings icon.
  </Step>
  ...
  <Step title="Disconnect">
    Click <b>Disconnect</b> for that integration.
  </Step>
</Steps>
