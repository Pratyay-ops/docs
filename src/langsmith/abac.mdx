...
<Note>
Attribute-Based Access Control (ABAC) is currently in beta.
</Note>


<Note>
ABAC (Attribute-Based Access Control) is an Enterprise feature. If you are interested in upgrading to Enterprise, [contact our sales team](https://www.langchain.com/contact-sales).
</Note>
