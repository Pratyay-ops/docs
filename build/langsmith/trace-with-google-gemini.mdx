...
This example shows how to trace a Google Gemini model call in Python using LangSmith’s [`traceable`](https://reference.langchain.com/python/langsmith/observability/sdk/run_helpers/#langsmith.run_helpers.traceable) decorator. This approach requires minimal setup and is suited for capturing basic model inputs and outputs:
