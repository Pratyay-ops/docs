...
Set these environment variables for all implementations:
...
:::info
For EU region or self-hosted LangSmith installations, also set:
- `LANGCHAIN_BASE_URL` - Your LangSmith instance URL
:::
...
The integration has three main steps:

1. Initialize the LangSmith tracer
2. Create Temporal's OpenTelemetry interceptor
3. Register the interceptor with your Temporal client and worker
...
#### Execute Workflow (Separate Script)
