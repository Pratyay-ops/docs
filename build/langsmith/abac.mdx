...
sidebarTitle: Attribute-based access control (beta)
---

This reference explains LangSmith's Attribute-Based Access Control (ABAC) system, which enables fine-grained access control based on resource attributes, complementing [RBAC](/langsmith/rbac). ABAC is currently in open beta. 

<Note>
ABAC (Attribute-Based Access Control) is an Enterprise feature for fine-grained access to resources. If you are interested in this feature, [contact our sales team](https://www.langchain.com/contact-sales).
</Note>

<Check>
In order to use ABAC, you must [set up resource tags](/langsmith/set-up-resource-tags) in your workspace.
</Check>
...
<Info>
**Currently supported attribute**: `resource_tag_key` - ABAC conditions evaluate against resource tags. No other attribute types are supported yet.
</Info>
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit the source of this page on GitHub.](https://github.com/langchain-ai/docs/edit/main/src/langsmith/abac.mdx)
</Callout>
